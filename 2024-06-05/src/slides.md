...
<div abs-br mx-10 my-12 flex="~ col" text-sm text-right>
  <div>Frontend Nation</div>
  <div text-sm opacity-50>June 5th 2024</div>
</div>
...
- Automatic scaling
- Affordable
  - Cloudflare: 100,000 requests/day for free + $0.30/million requests per month (CF Workers)
...
# Meet the [NuxtHub]{.text-green} module
